...
## Ideas for CP1
Here are some ideas for Autumn 2019 (your instructor is more than happy to help discuss more in their office hours!):
...
* Check out your TA's [About Pages](https://courses.cs.washington.edu/courses/cse154/19au/) and a previous [CP1
  showcase](https://courses.cs.washington.edu/courses/cse154/19sp/creative/cp-showcase.html) for some more inspiration!
...
* Internal Correctness (2.5 pts)
* Documentation (1 pts)
* Wireframe (`wireframe.png` or `wireframe.pdf`) - (0.5 pts)
...
and follow the Academic Integrity/Collaboration Policies outlined in more detail on the syllabus [here](https://courses.cs.washington.edu/courses/cse154/19au/syllabus/index.html#cp-policies). If we find inappropriate content or plagiarism in CPs **you will be ineligible
for any points on the CP**. Ask the instructor if you're unsure if your work is cited appropriately. Any external sources like images should be cited where used in the source code or (ideally) visible in a page footer. Refer to this [copyright example](https://courses.cs.washington.edu/courses/cse154/19au/code-examples/copyright-examples/copyrightexample2.html) page for how to cite images from different sources.

### CP1 Showcase Opt-in
You can opt-in to the CP1 class showcase when submitting through GitGrade. We look forward to seeing what students create!
...
* Include a creative `404.html` page unique to your website. It should be linked somewhere from your about.html ("simulating" a 404 page not found redirect, even though it is not a result of a user finding a broken link on your website - we just want to be able to access it from your CP1 pages).
...
* Your 404 page must indicate to the user somehow that they are on a "page not found" landing page on your website. You can find some inspiration from some of the lecture slides posted on the course website!
